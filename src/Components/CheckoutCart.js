  ...
  return (
    <div className='px-6 py-5 md:w-1/2 lg:w-1/3 w-full h-full rounded-md shadow-lg'>
      ...
      <div className='flex border-t border-gray-200 py-2'>
        <span className='text-gray-500'>${homeData?.price} x {homeData?.totalNights} nights</span>
        <span className='ml-auto text-gray-900'>${homeData?.sub_total}</span>
      </div>
      <div className='flex border-t border-gray-200 py-2'>
      ...
      <div className='flex border-t border-b mb-6 border-gray-200 py-2'>
        ...
        <span className='ml-auto text-gray-900'>${homeData?.total}</span>
      </div>
    </div>
  )
}
